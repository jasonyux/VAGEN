...
use_multiturn_reward=True
use_loss_mask=True
exp_name="trico_sokoban_terminal_vision-use_multiturn_reward$use_multiturn_reward-use_loss_mask$use_loss_mask"
...
python -m vagen.trainer.main_ppo \
    ...
    rollout_manager.use_multi_turn_reward=$use_multiturn_reward \
    rollout_manager.use_loss_mask=$use_loss_mask \
    rollout_manager.use_gae_mask=$use_loss_mask \
